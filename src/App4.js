...
class RefItems extends Component {
            ...
            <div>
                <div className="row">
                    <div className="col-4">
                        ...
                        <a className="list-group-item list-group-item-action active" id="list-home-list" data-toggle="list" href="#list-home" role="tab" aria-controls="home">Amazon Forecast</a>
                    ...
                    <div className="col-8">
                        ...
                        <div className="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">hola</div>
